...
@Component({
  selector: 'app-marriage-english',
  templateUrl: './marriage-english.component.html',
  styleUrls: ['./marriage-english.component.css']
})
export class MarriageEnglishComponent {
  ...
  marriageEnglishData = {
    ...
    wifeFatherName: '',
    wifeMotherName: '',
    wifeCertificateIssuer: '',
    solemnziarName: '',
    solemnizationPlace: '',
    solemnizationDate: '',
    solemnizationOfficerName: '',
    marriagePlace: '',
    marriageWitness1Name: '',
    marriageWitness2Name: '',
    marriageWitness1Recidance: '',
    marriageWitness2Recidance: '',  
    marriageWitness1Profession: '',
    marriageWitness2Profession: '',
    marriageRegistrarName: '',
    marriageStatementNo: '',
    DistricstRegistrarName: '',
    DistricstRegistrarEntryDate: '',
    marriageDate: '',
    officerName: '',
    officeName: '',
    date:'',
    ...
    generatePDF() {
      ...
      html2canvas(page1Element, {
          ...
          html2canvas(page2Element, {
              ...
              pdf.save('Marriage_English_Certificate.pdf');
