...
@Component({
  selector: 'app-death-english',
  templateUrl: './death-english.component.html',
  styleUrls: ['./death-english.component.css']
})
export class DeathEnglishComponent {
  ...
  generatePDF() {
    ...
    html2canvas(element, {
      ...
      // Save the PDF
      pdf.save('Death_English_Certificate.pdf');
