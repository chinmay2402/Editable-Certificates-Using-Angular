...
@Component({
  selector: 'app-birth-italian',
  templateUrl: './birth-italian.component.html',
  styleUrls: ['./birth-italian.component.css']
})
export class BirthItalianComponent  {
  ...
  generatePDF() {
    ...
    html2canvas(page1Element, {
        ...
        html2canvas(page2Element, {
            ...
            pdf.save('Birth_Italian_Certificate.pdf');
